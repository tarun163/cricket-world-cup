      ...
      <span class="navbar-toggler-icon "></span>
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent ">
                <ul class="navbar-nav mr-auto ">
                    ...
                    <li class="nav-item active ">
                        <a style="font-size: 1.2rem; " class="nav-link " href="\cricket-world-cup/fix.html ">Fixtures<span class="sr-only ">(current)</span></a>
                    </li>
                    ...
                    <li class="nav-item active ">
                        <a style="font-size: 1.2rem; " class="nav-link " href="\cricket-world-cup/team.html">Teams<span class="sr-only ">(current)</span></a>
                    </li>
                    <li class="nav-item active ">
...
<?php include 'team-inner/westindies.php'; ?>
