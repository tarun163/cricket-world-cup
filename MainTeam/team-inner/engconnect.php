...
// playing 11
$result=$connection->query("SELECT * FROM england");
...
<br>
<h2> Batsman List</h2>
<p>Here is the List of Batsman for the England cricket Team :</p>
...
// Batsman table
  $batsman=$connection->query("SELECT player_name FROM england WHERE Player_role='Batsman'");
...
<br>
<h2> Bowlers List</h2>
<p>Here is the List of Bowlers for the England cricket Team :</p>
...
// Bowlers table
  $BOWLER=$connection->query("SELECT player_name FROM england WHERE Player_role='Bowler'");
...
<p>Here is the List of All Rounders for the England cricket Team :</p>
...
// All Rounder Table
$All=$connection->query("SELECT player_name FROM england WHERE Player_role='AllRounder'");
...
// coach
$All=$connection->query("SELECT coach_name FROM teams WHERE team_name='England'");
while ($row1 = $All->fetch_array(MYSQLI_ASSOC)) {
  ?>
